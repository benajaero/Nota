...
$(document).ready(() => {
    ...
    storage.has('notae', (err, haskey) => {
        ...
        button.addEventListener('click', () => {
            ...
            fs.writeFile(path.join(__dirname,'notae', obj.file), "# This is an empty file", 'utf-8', err => {
                if (err) throw err
            })
        ...
        deleter.addEventListener('click', () => {
            ...
            fs.unlink(path.join(__dirname, 'notae', currentNota.file), (err) => {
                if (err) throw err
            })
        ...
        ipc.on('save', () => {
            ...
            fs.writeFile(path.join(__dirname, 'notae', currentNota.file), $('#input').val(), 'utf-8', (err) => {
                if (err) throw err
            })
            //show save banner
        })
